...
/* susfs_stage6_trial40_coreonly_copy_config_helper */
...
void susfs_get_enabled_features(void __user **user_info) {
	...
	char *buf_ptr = NULL;
	size_t copied_size __maybe_unused = 0; /* susfs_stage6_trial40_coreonly_copied_size */
	int err = 0;
...
/* susfs_stage6_trial44_extra_worker_maybe_unused */
static void __maybe_unused susfs_run_extra_works(struct work_struct *work) {
	if (!ksu_cred)
		return;
#ifdef CONFIG_KSU_SUSFS_SUS_PATH
...
void susfs_init(void) {\
	...
	/* susfs_stage6_trial43_susfs_init_work_suppressed: INIT_WORK(&susfs_extra_works, susfs_run_extra_works); */
